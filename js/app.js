  ...
  function ($stateProvider, $urlRouterProvider, $indexedDBProvider) {
    ...
    $indexedDBProvider
      ...
      .upgradeDatabase(1, function(event, db, tx){
        ...
        var objStore = db.createObjectStore('drawings', {keyPath: 'id',autoIncrement: true});
        objStore.createIndex('id_idx', 'id', {unique: true});

        var objStore = db.createObjectStore('subcontractors', {keyPath: 'id',autoIncrement: true});
        objStore.createIndex('id_idx', 'id', {unique: true});

        var objStore = db.createObjectStore('defects', {keyPath: 'id',autoIncrement: true});
        objStore.createIndex('id_idx', 'id', {unique: true});
      });
